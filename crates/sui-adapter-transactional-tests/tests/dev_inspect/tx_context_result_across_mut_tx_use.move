...
// --allow-references-in-ptbs, a `&mut Y` returned from `borrow_mut(&mut X, &mut TxContext)`
...
// return values even without the flag, so the pair isolates exactly what the TxContext
// carve-out changes.
