...
mod checked {
    ...
    impl SuiGasStatus {
        ...
        /// Computation cost reported in `summary()`, capped so `computation + storage_cost - sender_rebate
        /// ≤ gas_budget`: storage charges stick, computation absorbs whatever budget remains.
