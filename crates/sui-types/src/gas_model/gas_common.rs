...
mod checked {
    ...
    pub struct StorageGas {
        ...
        /// Running total of storage rebate. On the unmetered (system-tx) path this holds the rebate
        /// retained in effects; on the metered path it mirrors the sum of per-object rebates.
        ...
        pub fn track_mutation(
            ...
            if unmetered {
                return self
                    ...
                    .map(|total| {
                        self.total_storage_rebate = total;
                        0
                    });
            }
